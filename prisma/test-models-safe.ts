...
async function testModels() {
  ...
  // Safely testing models with correct casing based on schema
  ...
  // According to the schema, it's ApiKey, which should become apiKey in the client
  console.log('Testing apiKey (from ApiKey model):', typeof prisma.apiKey?.create);
