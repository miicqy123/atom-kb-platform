...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  ATOM_PROCESSING: { label: "原子化中", className: "bg-blue-100 text-blue-700 animate-pulse" },
  QA_PROCESSING:   { label: "QA生成中", className: "bg-purple-100 text-purple-700 animate-pulse" },
  DUAL_PROCESSING: { label: "双轨加工中", className: "bg-indigo-100 text-indigo-700 animate-pulse" },
  ATOM_DONE:       { label: "已原子化", className: "bg-blue-100 text-blue-700" },
  QA_DONE:         { label: "已向量化", className: "bg-purple-100 text-purple-700" },
  DUAL_DONE:       { label: "已入2库", className: "bg-green-100 text-green-700" },
